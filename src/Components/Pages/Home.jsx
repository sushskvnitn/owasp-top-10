  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-500 via-purple-400 to-pink-600 flex flex-col justify-center items-center p-6">
      <div className="rounded-xl shadow-lg w-full max-w-4xl bg-white p-8 relative overflow-hidden">
        ...
        <Link
          to='/OwaspTop10'
          className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded mt-4 transition duration-300 ease-in-out"
        >
          Start Exploring
        </Link>
      </div>
      ...
      <div className="bg-gray-100 p-8 rounded-lg shadow-md mt-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {Vulnerabilities.map((vuln, index) => (
            <div
              key={index}
              className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition duration-300 ease-in-out relative overflow-hidden"
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-base text-gray-200 mb-4">{vuln.description}</p>
              </div>
            </div>
          ))}
        </div>
